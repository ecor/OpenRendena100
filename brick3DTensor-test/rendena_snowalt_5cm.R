...
me <- lapply(X=m,FUN=function(x,alt,asp,aspcat,valmin){
		...
		},alt=alt_map,asp=aspect_cat_map,aspcat=aspect_cat,valmin=50)
...
file <- './output/alt_snow50_vs_time_daily.csv' ###'/home/ecor/Dropbox/R-packages/geotopbricks/inst/brick3DTensor-test/output/alt_snow_vs_time_daily.csv' 
